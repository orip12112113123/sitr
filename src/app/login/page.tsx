        ...
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-4 border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-4 bg-[#1877F2] rounded-lg font-semibold text-white hover:bg-[#166FE5] transition-colors flex items-center justify-center gap-3"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-4 bg-black rounded-lg font-semibold text-white hover:bg-gray-900 transition-colors flex items-center justify-center gap-3"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
