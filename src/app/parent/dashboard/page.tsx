...
import { Baby, LogOut, MapPin, Car, DollarSign, Star, Search, Filter } from 'lucide-react';
...
export default function ParentDashboard() {
  ...
  const fetchBabysitters = async () => {
    try {
      ...
      setFilteredBabysitters(data.babysitters);
    } catch (error) {
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {filteredBabysitters.length === 0 && (
          <div className="text-center py-12">
            ...
            <button
              onClick={() => {
                setFilters({ location: '', maxRate: '', minRating: '', transportation: '' });
